...
config.General.workArea = 'R_jpsi_%s' % production_tag
...
config.JobType.psetName = '../test/run_nanomu_cfg.py'
...
if __name__ == '__main__':
  ...
  parser.add_argument('-y', '--yaml', default = 'samples_mmm.yml', help = 'File with dataset descriptions')
...
#      print(sample,info)
      ...
      for part in parts:
        ...
        config.JobType.outputFiles = ['_'.join(['R_jpsi_', 'mc' if isMC else 'data', production_tag])+'.root']
