...
#MODIFICARE QUI??-----------------------------------------------------------   
    #kaons = BToKee.kaons,
    #questo e' il token che mi fa accedere ai dai di muoni della collezione SelectedMuons
...
BTommmTables = cms.Sequence(BTommmTable)
