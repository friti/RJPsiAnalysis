...
#        tightCharge = Var("?(muonBestTrack().ptError()/muonBestTrack().pt() < 0.2)?2:0",int,doc="Tight charge criterion using pterr/pt of muonBestTrack (0:fail, 2:pass)"),
        ...
        raw_ch_iso04 = Var("pfIsolationR04().sumChargedHadronPt",float, doc = "raw pf iso charged hadrons"),
        raw_n_iso04 = Var("pfIsolationR04().sumNeutralHadronEt",float, doc = "raw pf iso neutral hadron"),
        raw_pho_iso04 = Var("pfIsolationR04().sumPhotonEt",float, doc = "raw pf iso photons"),
        raw_pu_iso04 = Var("pfIsolationR04().sumPUPt",float, doc = "raw pf iso PU"),
        raw_ch_iso03 = Var("pfIsolationR03().sumChargedHadronPt",float, doc = "raw pf iso charged hadrons"),
        raw_n_iso03 = Var("pfIsolationR03().sumNeutralHadronEt",float, doc = "raw iso neutral hadron"),
        raw_pho_iso03 = Var("pfIsolationR03().sumPhotonEt",float, doc = "raw pf iso photons"),
        raw_pu_iso03 = Var("pfIsolationR03().sumPUPt",float, doc = "raw pf iso PU"),
